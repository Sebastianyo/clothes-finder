							...
							<form method="POST" class="needs-validation" novalidate="" autocomplete="off"> 
								...
								<div class="mb-3">
                                 ...
                                 <div class="mb-3">
									...
									<input id="name" type="tel" class="form-control" name="celular_u" value="" required autofocus>
									<div class="invalid-feedback">
									</div>
								</div>
                                 ...
                                 <div class="mb-3">
									...
									<input id="name" type="tel" class="form-control" name="telefono_u" value="" required autofocus>
									<div class="invalid-feedback">
									</div>
								</div>
...
if (isset($_POST['register'])) {
  if (strlen($_POST['nombre_u']) >=1 &&
     ...
     $consulta = "INSERT INTO usuario(nombre_u, apellido_u, celular_u, telefono_u, tipo_documento_u, documento_u, fecha_naci_u, comuna, barrio, direccion_u, email_u, password_u) 
     VALUES ('$nombre_u','$apellido_u','$celular_u','$telefono_u','$tipo_documento_u','$documento_u','$fecha_naci_u','$comuna','$barrio','$direccion_u','$email_u','$password_u')";
