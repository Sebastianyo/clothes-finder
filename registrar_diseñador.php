						...
						<div class="card-body p-5">
							...
							<form method="POST" class="needs-validation" novalidate="" autocomplete="off"> 
								...
								<div class="mb-3">
									...
									<input id="name" type="tel" class="form-control" name="telefono_d" value="" required autofocus>
									<div class="invalid-feedback">
									</div>
								</div>
								...
								<div class="mb-3">
									...
									<input id="name" type="tel" class="form-control" name="celular_d" value="" required autofocus>
									<div class="invalid-feedback">
									</div>
								</div>
